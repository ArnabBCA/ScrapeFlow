...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-screen flex-col items-center justify-center overflow-hidden rounded-md z-0",
        className
      )}
    >
      ...
      <div className="z-50 flex flex-col items-center px-5 -translate-y-[calc(100%)]">
        {children}
      </div>
    </div>
  );
